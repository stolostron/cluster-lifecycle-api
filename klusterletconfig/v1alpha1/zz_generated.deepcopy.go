...
func (in *KlusterletConfigSpec) DeepCopyInto(out *KlusterletConfigSpec) {
	*out = *in
	...
	if in.MultiHubConfig != nil {
		in, out := &in.MultiHubConfig, &out.MultiHubConfig
		*out = new(MultiHubConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiHubConfig) DeepCopyInto(out *MultiHubConfig) {
	*out = *in
	in.BootstrapKubeConfigs.DeepCopyInto(&out.BootstrapKubeConfigs)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiHubConfig.
func (in *MultiHubConfig) DeepCopy() *MultiHubConfig {
	if in == nil {
		return nil
	}
	out := new(MultiHubConfig)
