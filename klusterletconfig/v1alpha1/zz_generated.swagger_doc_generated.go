...
var map_CABundle = map[string]string{
	...
	"name":         "Name is the identifier used to reference the CA bundle",
	"caBundleData": "CABundleData is base64 encoded certificate data",
	"caBundle":     "CABundle refers to a ConfigMap containing the user-provided CA bundle The key of the CA data must be \"ca-bundle.crt\". This field will be ignored if the CABundleData field is also present.",
}
